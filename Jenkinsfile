pipeline {
    ...
    environment {
        ...
        IMAGE_NAME = "vowly-client"
        CONTAINER_NAME = "vowly-client"
        DOCKER_NETWORK = "vowly"
        NETWORK_ALIAS = "vowly-client"
        CONTAINER_PORT = "3303"
        HEALTH_PATH = "/api/health"
        NEXT_PUBLIC_APP_URL = "https://vowly.app"
...
REMOTE_VERIFY
    ...
    post {
        ...
        success {
            ...
            echo "App upstream: http://${NETWORK_ALIAS}:${CONTAINER_PORT}"
        }
        failure {
